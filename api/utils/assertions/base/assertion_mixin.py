...
from api.utils.assertions.base.assertion_base import AssertionBase
from api.utils.assertions.base.assertion_types import AssertionTypes
...
class AssertionMixin(AssertionBase):
    ...
    def to_be_instance_of(self, value, expected_class: type):
        step_name = f'Checking that "{self._description}"'
        with self.step_provider(step_name):
